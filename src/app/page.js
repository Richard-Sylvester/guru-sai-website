     ...
     {/* 2.Trust Banner (Logo Farm) */}
      ...
      <section className="w-full py-24 bg-slate-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Service Cards Container - Manages the staggered delay */}
          <motion.div 
            initial="hidden"
            whileInView="show"
          ...
          >
            ...
            <motion.div 
              ...
              className="bg-white p-8 rounded-lg shadow-sm border border-slate-200 hover:shadow-md transition"
            >
              <div className="w-12 h-12 bg-slate-100 text-amber-500 rounded flex items-center justify-center mb-6">
