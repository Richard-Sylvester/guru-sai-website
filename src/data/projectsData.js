  ...
  // src/data/projectsData.js sample entry
{
  ...
  fullScope: [
    {
      sectionTitle: "1. Site Preparation & Demarcation",
      items: [
    ...
    {
      sectionTitle: "2. Civil Utility Engineering Works",
      items: [
    ...
    {
      sectionTitle: "3. Electrical & Communication Infrastructure",
      items: [
    ...
    {
      sectionTitle: "4. Transportation & Surface Works",
      items: [
